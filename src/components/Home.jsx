...
const Home = () => {
    return (
        <section id="home" className="min-h-screen flex flex-col md:flex-row items-center justify-center text-center md:text-left text-white pt-24 p-8 space-y-8 md:space-y-0 md:space-x-12">

...
const Contact = () => {
    return (
        <section id="contact" className="py-20 bg-gray-900 text-white flex flex-col items-center justify-center min-h-screen w-full">
                    ...
                    {contacts.map((contact, index) => (
                        ...
                        >
                            <a href={contact.href} className="flex items-center justify-center">
                                <i className={`fab ${contact.icon} text-4xl mb-4`}></i>
                            </a>
